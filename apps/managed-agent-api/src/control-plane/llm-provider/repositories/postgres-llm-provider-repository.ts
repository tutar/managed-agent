...
const toRecord = (
	...
	return {
		...
		balancedModelId: row.balancedModelId ?? undefined,
		strongModelId: row.strongModelId ?? undefined,
		...
		async updateProviderConfig(providerConfigId, userId, patch) {
			await db
				...
				.set({
					...
					fastModelId: patch.fastModelId,
					balancedModelId: patch.balancedModelId,
					strongModelId: patch.strongModelId,
